...
PROXY = {'http':'http://13.112.242.128:52219','https':'https://13.112.242.128:52219'}
...
class Instagram:
    ...
    def __init__(self, username, maxtasks=1):
...
def check(_):
    ...
    with requests.get(urljoin(ROOT_URL, USERNAME), headers=HEADERS,
                 proxies={'http://13.112.242.128:52219', 'https://13.112.242.128:52219'}) as resp:
